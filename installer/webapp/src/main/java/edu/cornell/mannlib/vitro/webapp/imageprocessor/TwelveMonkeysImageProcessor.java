...
package edu.cornell.mannlib.vitro.webapp.imageprocessor;
 ...
 */
public class TwelveMonkeysImageProcessor implements ImageProcessor {
	private static final Log log = LogFactory.getLog(TwelveMonkeysImageProcessor.class);
