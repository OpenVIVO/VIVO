 ...
 */
public class OpenVIVOIndividualController extends FreemarkerHttpServlet {
	private static final Log log = LogFactory
			.getLog(OpenVIVOIndividualController.class);
	...
	private IndividualRequestInfo analyzeTheRequest(VitroRequest vreq) {
		return new OpenVIVOIndividualRequestAnalyzer(vreq,
