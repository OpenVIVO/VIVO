...
public class GeoLocatedMapLocations extends AbstractAjaxResponder {

    private static final Log log = LogFactory.getLog(GeoLocatedMapLocations.class.getName());
...
/*        + "} UNION {   \n"
	...
	public GeoLocatedMapLocations(HttpServlet parent, VitroRequest vreq,
