...
public class GeoLocatedResearcherCount extends AbstractAjaxResponder {

    private static final Log log = LogFactory.getLog(GeoLocatedResearcherCount.class.getName());
	...
	public GeoLocatedResearcherCount(HttpServlet parent, VitroRequest vreq,
